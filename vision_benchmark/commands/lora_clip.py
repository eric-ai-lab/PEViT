...
from vision_benchmark.evaluation.lora_clip import *
...
def main():
    ...
    best_acc, model_info = lora_tuning_clip(train_dataloader, val_dataloader, test_dataloader, args.no_tuning, args.lr, args.l2, config)
